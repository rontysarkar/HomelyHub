...
const EstateCard = ({ estate }) => {
    const { image, estate_title, segment_name, description, price, location, status, area } = estate
    return (
        <div className=" w-11/12 xl:w-full mx-auto rounded-md shadow-md dark:bg-gray-50 ">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                <div className="space-y-2">
                    ...
                    <p className="dark:text-gray-800">{description.slice(0, 120)}......</p>
                ...
                <button type="button" className="btn bg-[#e7f6fd] text-[#1db2ff] ">View Property</button>
            </div>
        </div>
    );
};
